        ...
        >
            ...
            <View style={styles.header}>
                <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.headerSub}>{t.student}: {user.name}</Text>
                </View>
                <View style={{ flex: 1 }}>
                    <Text style={styles.headerLabel}>{t.week} 1</Text>
                </View>
            </View>

            {/* Grid Table */}
            <View style={[styles.table, { borderColor: theme.border, borderStartWidth: 1.5, borderTopWidth: 1.5, direction: isAr ? 'rtl' : 'ltr', borderRadius: theme.radius / 2 }]}>
                {/* Table Header Row */}
